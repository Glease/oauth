...
//
// public class PasswordFieldWidgetOld extends Gui implements IRenderable, IGuiEventListener {
...
// };
//
// public PasswordFieldWidgetOld(FontRenderer p_i232260_1_, int p_i232260_2_, int p_i232260_3_, int p_i232260_4_, int
// p_i232260_5_, ITextComponent p_i232260_6_) {
// this(p_i232260_1_, p_i232260_2_, p_i232260_3_, p_i232260_4_, p_i232260_5_, (TextFieldWidget) null, p_i232260_6_);
// }
//
// public PasswordFieldWidgetOld(FontRenderer p_i232259_1_, int p_i232259_2_, int p_i232259_3_, int p_i232259_4_, int
// p_i232259_5_, @Nullable TextFieldWidget p_i232259_6_, ITextComponent p_i232259_7_) {
...
// return false;
// } else {
// boolean flag = p_231044_1_ >= (double) this.x && p_231044_1_ < (double) (this.x + this.width) && p_231044_3_ >=
// (double) this.y && p_231044_3_ < (double) (this.y + this.height);
...
// j1 = this.font.drawShadow(p_230431_1_, this.formatter.apply(s1, this.displayPos), (float) l, (float) i1 + 2, i2);
// }
//
...
// this.font.drawShadow(p_230431_1_, this.formatter.apply(s.substring(j), this.cursorPos), (float) j1, (float) i1 + 2f,
// i2);
// }
//
...
// return this.visible && p_231047_1_ >= (double) this.x && p_231047_1_ < (double) (this.x + this.width) && p_231047_3_
// >= (double) this.y && p_231047_3_ < (double) (this.y + this.height);
// }
//
